set_project("HV8's Final Project")
set_version("1.0.0")
set_xmakever("2.6.9")
set_languages("cxx20")
...
target("assets")
    ...
    after_build(function (target)
        ...
        os.mkdir(path.join(target:targetdir(), "assets", "fonts"))
        os.cp("assets/fonts/*.ttf", path.join(target:targetdir(), "assets", "fonts"))
    end)
...
target("HV8")
    set_kind("binary")
    add_deps("lab-common")
    --add_packages("itk"     , { public = true })
    add_headerfiles("src/VCX/Labs/Final/*.h")
    add_headerfiles("src/VCX/Labs/Final/*.hpp")
    add_files      ("src/VCX/Labs/Final/*.cpp")